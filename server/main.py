...
DISPLAY = {
    ...
    "tiktok":    {"id":"tiktok",    "name":"TikTok",    "desc":"просмотры, фолловеры, комментарии и многое др."},
    "instagram": {"id":"instagram", "name":"Instagram", "desc":"подписчики, лайки, комментарии, охваты и многое др."},
    "youtube":   {"id":"youtube",   "name":"YouTube",   "desc":"просмотры, подписки, лайки, комментраии и многое др."},
    "facebook":  {"id":"facebook",  "name":"Facebook",  "desc":"лайки, подписчики, просмотры, реакции и многое др."},
}
